...
private:
    ...
    void sendICMPT3Unreachable(const Packet& originalPacket, const std::string& ifaceSrc, const std::string& ifaceDest, uint8_t code);
    void sendICMPT11Unreachable(Packet& originalPacket, const std::string& iface);
};
